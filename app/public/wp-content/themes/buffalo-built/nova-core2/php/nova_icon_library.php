...
function iconLibrary($library) {
    $iconList = '';
    foreach ($library['icons'] as $icon) {
        $iconList .= '<div class="icon-molecule"><i class="' . $library['icon_class'] . ' ' . $library['icon_prefix'] . $icon . '"></i> <span class="icon-description">' . $icon . '</span></div>';
    }
...
function meta_options_icon_library() {
    ...
    <div class="nova-icon-library nova-pop-up-area">
        <div class="nova-icon-library-inner">
            ...
            if ($nova_custom_icon_libraries_before) {
                foreach ($nova_custom_icon_libraries_before as $library) {
                    $libraries[] = $library;
                }
            }
            ...
            if ($nova_custom_icon_libraries_after) {
                foreach ($nova_custom_icon_libraries_after as $library) {
                    $libraries[] = $library;
                }
            }
            ?>
            
            <?php if (ICON_LIBRARY_CHOICE_NONE) : ?>
            <hr />
            ...
            <?php foreach ($libraries as $library) : ?>
                <hr />
                <h2><i class="<?php echo $library['icon_class'] . ' ' . $library['icon_prefix'] . $library['example_icon']; ?>"></i> <?php echo $library['name']; ?> Icons</h2>
                <?php echo iconLibrary($library); ?>
            <?php endforeach; ?>
        </div>
        <div class="nova-pop-up-controls">
            <a class="button nova-cancel-icon" href="#">Cancel <i class="fa fa-close"></i></a>
        </div>
    </div>
<?php } ?>