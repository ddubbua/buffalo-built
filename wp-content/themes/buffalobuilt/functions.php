...
require_once('nova-theme/helpers.php');

foreach (glob(get_stylesheet_directory() . '/nova-theme/custom-post-types/*.php') as $filename) {
    include $filename;
}
...
function nova_scripts() {
    ...
    wp_enqueue_script('scrollr-script', get_template_directory_uri() . '/js/lib/skrollr.min.js', array('jquery'));
    wp_enqueue_script('nova-script', get_template_directory_uri() . '/js/main.js', array('jquery'));
    wp_enqueue_script('classie-script', get_template_directory_uri() . '/js/lib/preload/classie.js', array('jquery'));
    wp_enqueue_script('pathloader-script', get_template_directory_uri() . '/js/lib/preload/pathloader.js', array('jquery'));
    wp_enqueue_script('modernizr-script', get_template_directory_uri() . '/js/lib/preload/modernizr.custom.js', array('jquery'));
    wp_enqueue_script('preload-script', get_template_directory_uri() . '/js/lib/preload/main.js', array('jquery'));
}
